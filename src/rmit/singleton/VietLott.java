...
public class VietLott {
    //Vietllot Singleton
    private static VietLott instance = null;
    private VietLott(){

    }
    public static VietLott getInstance(){
        if(instance == null){
            instance = new VietLott();
        }
        return instance;
    }

    //Customer Singleton
    private ListCustomer manageCustomer = ListCustomer.getInstance();
    private Map<Integer, Customer> customerList = manageCustomer.getLsCustomer();

    //Shop Singleton
    private ListShop manageShop = ListShop.getInstance();
    private Map<Integer, Shop> shopList = manageShop.getLsShop();

    private Decorator drawing = new TimeDrawingDecorator(new Drawing());
    private int customerID=1, shopID=1;
    ...
    private void customer(Map<Integer, Customer> customerList) {
        ...
        while (!userOption.equals("5")) {
            ...
            switch (userOption) {
                case "1":
                    id = customerID++;
                    Customer cus = new Customer(id, v.getName(), v.getBirthdate(), v.getAddress(),
    ...
    private void shop(Map<Integer, Shop> shopList) {
        ...
        while (!userOption.equals("5")) {
            switch (userOption) {
                case "1":
                    id = shopID++;
                    shopList.put(id, new Shop(id, v.getAddress(), v.getName(), v.getEmail(), v.getPhone(),
                            v.getAccountBalance()));
                    System.out.println("Add Successful!!");
                    break;
                case "2":
    ...
    private String getShopEditOption(){
    ...
    private String getCustomerEditOption() {
        System.out.println("---------------------------------------------------------------------------" +
                "----------------------------------------");
    ...
    private String getUserOptionMain() {
        System.out.println("---------------------------------------------------------------------------" +
                "----------------------------------------");
    ...
    private String getUserOptionCustomer() {
        System.out.println("---------------------------------------------------------------------------" +
                "----------------------------------------");
    ...
    private String getUserOptionShop() {
        System.out.println("---------------------------------------------------------------------------" +
                "----------------------------------------");
    ...
    private String getUserOptionBuying() {
        System.out.println("---------------------------------------------------------------------------" +
                "----------------------------------------");
    ...
    private String getUserOptionDrawing() {
        System.out.println("---------------------------------------------------------------------------" +
                "----------------------------------------");
    ...
    private String getUserOptionNewDraw(int[] jackpot) {
        System.out.println("---------------------------------------------------------------------------" +
                "----------------------------------------");
